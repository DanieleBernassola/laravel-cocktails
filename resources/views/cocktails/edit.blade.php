            ...
            <form action="{{ route('cocktails.update', $cocktail->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                        value="{{ old('name', $cocktail->name) }}" placeholder="ex: Mojito" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="price" name="price"
                        value="{{ old('price', $cocktail->price) }}" placeholder="ex: 5.99" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="gradation" name="gradation"
                        value="{{ old('gradation', $cocktail->gradation) }}" placeholder="ex: 5.00" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" id="is_alcoholic" name="is_alcoholic" required>
                        <option value="1" {{ old('is_alcoholic', $cocktail->is_alcoholic) == 1 ? 'selected' : '' }}>Si
                        </option>
                        <option value="0" {{ old('is_alcoholic', $cocktail->is_alcoholic) == 0 ? 'selected' : '' }}>No
                        </option>
                    </select>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    @if ($cocktail->image)
                        <label class="text-blue">Immagine attuale:</label>
